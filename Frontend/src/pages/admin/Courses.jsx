          ...
          <table className="w-full text-sm">
            <thead className="bg-surface-muted dark:bg-gray-800/50">
              <tr>
                ...
                <th className="text-left py-3 px-4 font-semibold text-gray-600 dark:text-gray-300">Instructor</th>
            ...
            <tbody>
              {courses.map(course => (
                <tr key={course.id} className="border-t border-gray-50 dark:border-gray-800 hover:bg-surface-muted dark:hover:bg-gray-800/50 transition">
                  <td className="py-3 px-5 font-medium text-ink dark:text-white max-w-[200px] truncate">{course.title}</td>
                  <td className="py-3 px-4 text-gray-500 dark:text-gray-400">{course.instructor?.name || '—'}</td>
        ...
        {deleteModal && (
          <div className="space-y-4">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Permanently delete <strong className="text-ink dark:text-white">"{deleteModal.title}"</strong>?
